# Generated by Django 3.2.12 on 2024-05-04 19:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etudiant', models.ForeignKey(limit_choices_to={'is_Etudiant': True}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ine', models.CharField(blank=True, max_length=50, null=True, unique=True)),
                ('pv', models.CharField(blank=True, max_length=20, null=True, unique=True)),
                ('pere', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('ecole_origine', models.CharField(blank=True, max_length=10, null=True)),
                ('tel', models.CharField(blank=True, max_length=50, null=True)),
                ('photo_profile', models.ImageField(blank=True, null=True, upload_to='img_profile_etudiant')),
                ('departement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Application.departement')),
                ('licence', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Application.licence')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Etudiant', models.ForeignKey(limit_choices_to={'is_Etudiant': True}, on_delete=django.db.models.deletion.CASCADE, to='Application.etudiant')),
                ('matiere', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Application.matiere')),
            ],
            options={
